...
class StationApi
{
    ...
    /**
     * Operation stationBroadcastByIdGet
     *
     * Get a specific broadcast, and all the available information for that broadcast
     *
     * @param  int $broadcast_id Only retrieve a specific program (optional)
     *
     * @throws \RadioCorp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \RadioCorp\Model\StationBroadcastById
     */
    public function stationBroadcastByIdGet($broadcast_id = null)
    {
        list($response) = $this->stationBroadcastByIdGetWithHttpInfo($broadcast_id);
        return $response;
    }

    /**
     * Operation stationBroadcastByIdGetWithHttpInfo
     *
     * Get a specific broadcast, and all the available information for that broadcast
     *
     * @param  int $broadcast_id Only retrieve a specific program (optional)
     ...
     * @throws \RadioCorp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \RadioCorp\Model\StationBroadcastById, HTTP status code, HTTP response headers (array of strings)
     */
    public function stationBroadcastByIdGetWithHttpInfo($broadcast_id = null)
    {
        $request = $this->stationBroadcastByIdGetRequest($broadcast_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RadioCorp\Model\StationBroadcastById' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RadioCorp\Model\StationBroadcastById', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RadioCorp\Model\StationBroadcastById';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RadioCorp\Model\StationBroadcastById',
    ...
    /**
     * Operation stationBroadcastByIdGetAsync
     *
     * Get a specific broadcast, and all the available information for that broadcast
     *
     * @param  int $broadcast_id Only retrieve a specific program (optional)
     ...
     */
    public function stationBroadcastByIdGetAsync($broadcast_id = null)
    {
        return $this->stationBroadcastByIdGetAsyncWithHttpInfo($broadcast_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation stationBroadcastByIdGetAsyncWithHttpInfo
     *
     * Get a specific broadcast, and all the available information for that broadcast
     *
     * @param  int $broadcast_id Only retrieve a specific program (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stationBroadcastByIdGetAsyncWithHttpInfo($broadcast_id = null)
    {
        $returnType = '\RadioCorp\Model\StationBroadcastById';
        $request = $this->stationBroadcastByIdGetRequest($broadcast_id);
    ...
    /**
     * Create request for operation 'stationBroadcastByIdGet'
     *
     * @param  int $broadcast_id Only retrieve a specific program (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function stationBroadcastByIdGetRequest($broadcast_id = null)
    {

        $resourcePath = '/Station/BroadcastById';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
