...
/**
 * StationPresenterList Class Doc Comment
 *
 * @category Class
 * @package  RadioCorp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StationPresenterList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StationPresenterList';
    ...
    protected static $openAPITypes = [
        'result' => 'bool',
        'error' => 'string',
        'data' => '\RadioCorp\Model\Presenter[]'
    ];
     ...
     * Sets data
     *
     * @param \RadioCorp\Model\Presenter[]|null $data data
     *
     * @return $this
     */
